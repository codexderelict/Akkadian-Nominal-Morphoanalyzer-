...
Tree-based constituency noun phrase mini-parser for valency/head marking in order to disambiguate the absolute and construct states. What I have in mind is this small semi-CFG, implemented through constraint as opposed to generation:  
